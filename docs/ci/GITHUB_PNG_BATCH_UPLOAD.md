...
- 40 PNG — только ориентир для больших наборов, не обязательный размер; если набор меньше, выкладывается весь набор.
...
- Для больших наборов размер и границы партий фиксируются в manifest/evidence; пример `40 + 40 + 40 + 40 + 32` не является обязательным шаблоном.
