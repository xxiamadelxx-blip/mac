...
Первым создаётся набор из трёх направлений меню в `docs/mockups/01-menu/`. Направление B рекомендовано как база; последующие визуальные этапы не считаются начатыми до закрытия этапа 1.