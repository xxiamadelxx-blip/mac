...
Первым создаётся набор из трёх направлений меню в `docs/mockups/01-menu/`. До выбора одного направления последующие визуальные этапы не считаются начатыми.