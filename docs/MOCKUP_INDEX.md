...
Этап 1 остаётся IN PROGRESS. По явному решению пользователя активирован этап 2: docs/mockups/02-arena/ теперь содержит реальный вертикальный арт, слои, контрольные кадры, карту данных и Godot runtime-preview. Этап 3 не начинается до закрытия текущих критериев арены.