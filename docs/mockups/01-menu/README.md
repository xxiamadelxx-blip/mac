...
- подготовить implementation-ready экраны Home, Heroes, Run Setup, Loading и Result;
...
Этап закрывается только после утверждения направления, создания всех обязательных экранов и состояний, проверки читаемости на телефоне, проверки safe area и фиксации навигационного маршрута без тупиков.
