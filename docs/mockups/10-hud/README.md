...
## Контентный бриф версия 01 — информационный договор интерфейса забега
...
- техническая проверка: NOT_RUN;
- художественное утверждение: PENDING;
- привязка и потребители: NOT_PROMOTED; предполагаемые потребители — проекция интерфейса, экран паузы и характеристик, карточки улучшений, интерфейс артефактов, информация о синергиях;
