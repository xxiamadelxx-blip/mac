...
## Контентный бриф версия 01 — десять общих пассивок забега
...
| passive_lotus_heart | Сердце лотоса | здоровье и преобразование лечения: укрепляет выживаемость и превращает разрешённое лечение в состояние лепестка для следующего удара | weapon_lotus_mines | synergy_lotus_sanctuary |
